...
export class CandidateService {
  ...
  saveCandidateToService(candidate:Candidate){
      return this.http.post("http://localhost:7292/api/candidate", candidate);
  }
  ...
  getAllCandidates():Observable<Candidate[]>{
    return this.http.get<Candidate[]>("http://localhost:7292/api/candidate"); 
  }

  deleteCandidateById(id:any){
    return this.http.delete("http://localhost:7292/api/candidate/"+id)
  }
